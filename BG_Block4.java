 ...
 */
public class BG_Block4 extends BG {

    public BG_Block4(World world, float x, float y,Bloxet game) {
    ...
    public void setTextureBounds() {
        setBounds(0,0,230/ Bloxet.PPM,230/ Bloxet.PPM);
    }
    ...
    public void update() {
        ...
        if(body.getPosition().x< -115/ Bloxet.PPM){
            body.setTransform(850/ Bloxet.PPM,560/ Bloxet.PPM,0);
        }
    }
