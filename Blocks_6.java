 ...
 */
public class Blocks_6 extends Blocks {
    ...
    public Blocks_6(World world, float x, float y,Bloxet game,boolean infinity) {
        super(world, x, y,game,infinity);

        this.game=game;
        this.infinity=infinity;

        texture=game.assetManager.get("block_6.png");
        blocksRegion=new TextureRegion(texture,0,0,67,67);

        sensorsSetToFalse();

        Blocks_6_array.delete_specific_body.add(this);
                ...
                if (y_down==18)
                {
                    ...
                    else
                    {
                        if (Grid.grid[y_down][x_movement + 1] == 0)
                        {
                            ...
                            Grid.grid[y_down][x_movement+1]=6;
    ...
    private void collision_detection(){
        ...
        //SQUARE
        if(Grid.grid[y_down][x_movement]==6 && (x_movement<10 &&(Grid.grid[y_down][x_movement+1]==6))
                && (y_down<18 &&(Grid.grid[y_down+1][x_movement]==6)) && (x_movement<10 && y_down<18 && (Grid.grid[y_down+1][x_movement+1]==6)))
        {
        ...
        //VERTICAL
        else if ((y_down<15) && (Grid.grid[y_down][x_movement] == 6 && Grid.grid[y_down+1][x_movement] == 6
                && Grid.grid[y_down+2][x_movement] == 6 && Grid.grid[y_down+3][x_movement] == 6))
        {
            deleteBlock=true;
        }
