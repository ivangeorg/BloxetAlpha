 ...
 */
public class BG_Block3 extends BG {

    public BG_Block3(World world, float x, float y,Bloxet game) {
    ...
    public void setTextureBounds() {
        setBounds(0,0,40/ Bloxet.PPM,40/ Bloxet.PPM);
    }
    ...
    public void update() {
        ...
        if(body.getPosition().x>600/ Bloxet.PPM){
            body.setTransform(-80/ Bloxet.PPM,670/ Bloxet.PPM,0);
        }
    }
