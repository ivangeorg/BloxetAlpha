 ...
 */
public class BG_Block6 extends BG {

    public BG_Block6(World world, float x, float y,Bloxet game) {
    ...
    public void update() {
        ...
        if(body.getPosition().x< -30/ Bloxet.PPM){
            body.setTransform(800/ Bloxet.PPM,300/ Bloxet.PPM,0);
        }
    }
